...
// Bridge tools removed in Sprint 16 (v1.0.0 release) — see git history for prior implementation.
// Removed: request_user_input, get_user_response, send_step_progress, send_claude_output,
// send_claude_step, handle_run_kickoff, handle_run_retro, handle_run_review.
