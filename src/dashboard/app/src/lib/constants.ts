...
export const MODEL_OPTIONS: readonly ModelOption[] = [
  ...
  { value: 'claude-opus-5', label: 'Opus 5', short: 'opus 5', description: 'Powerful', color: '#a78bfa' },
...
const LEGACY_MODELS: readonly ModelOption[] = [
  { value: 'claude-opus-4-8', label: 'Opus 4.8', short: 'opus 4.8', description: 'Powerful (previous gen)', color: '#a78bfa' },
