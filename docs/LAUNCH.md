# vlm-code-context-mcp v2.0.0 — Launch Materials
...
vlm-code-context-mcp: one MCP server that gives Claude a Product Owner, Scrum Master, QA, Security Specialist, and 5 more devs.

43 tools. React dashboard. Sprint management. Code intelligence.
...
40 sprints shipped. 316 tickets closed. 11 milestones delivered.

The entire thing was built by its own team. Here's how:

### LinkedIn
Excited to share vlm-code-context-mcp v2.0.0 — an open-source MCP server that turns any AI coding assistant into a complete virtual IT department.
...
- Built by its own scrum process (40 sprints, 316 tickets)

MIT licensed. Try it: npm install -g vlm-code-context-mcp

### Hacker News Title
Show HN: MCP server with 9 AI agents running real scrum (43 tools, React dashboard)
...
| Metric | Value |
|--------|-------|
| MCP Tools | 43 (10 code + 33 scrum) |
| AI Agents | 9 core + 7 extended (16 total) |
| Sprints Completed | 40 |
| Tickets Delivered | 316 |
| Milestones | 11 completed |
